...
@Component({
  ...
  styleUrls: ['./lottery-spinning-wheel.component.css'],
  //the wheel will spin only when the trigger allows it
  animations: [
...
export class LotterySpinningWheelComponent implements OnInit {
  ...
  constructor(private httpClient: HttpClient, public lotteryService: LotteryServiceService){ }
